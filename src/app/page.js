...
const Hero = () => {
  return (
    ...
    <Services/>
    <PartnerSection/>
    <h2 className="md:mt-[150px] container mx-auto text-center text-white md:text-[40px] text-[25px] font-bold mb-4">We Got 70+ appointments for one of our clients in just 14 days</h2>
