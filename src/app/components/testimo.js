...
const Testimonials = () => {
  return (
    <div className="mt-[-300px] md:mt-[-210px] bg-transparent p-6 rounded-lg text-white">
      <h2 className="text-[25px] md:text-[55px] text-center font-bold mb-4">What Our Clients Say</h2>
      <div className="flex overflow-x-auto space-x-4 scrollbar-hide">
        {testimonials.map((testimonial) => (
          <div
            key={testimonial.id}
            className="min-w-[300px] p-10 bg-white text-black rounded-lg shadow-lg hover:scale-105 transition-transform duration-300"
          >
