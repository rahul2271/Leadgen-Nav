...
const LogoMarquee = () => {
  return (
    <>
<h2 className="md:mt-[100px] mt-[-200px] container mx-auto text-center text-white/50 md:text-white/50 md:text-[32px] text-[15px] font-bold mb-4 decoration-white/50">
