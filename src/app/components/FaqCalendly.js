...
export default function FAQAndScheduleSection() {
  ...
  const faqs = [
    {
      ...
      answer:
        "We are committed to delivering exceptional results. We take on only a few clients each month, carefully selecting clients we are confident we can support with a 100% success rate. Our approach is grounded in a tried-and-tested model, backed by a track record that speaks for itself.",
    },
    {
      question: "How do you balance client growth?",
      answer:
        "Your success is our success. We position our client partners at the center of our growth strategy. We have invested in top-notch operations and marketing resources to ensure we provide unwavering support to our clients.",
    },
    {
      question: "What happens if the outbound strategy doesn’t work?",
      answer:
        "We replicate a proven model, invest in the partnership, and guarantee your satisfaction. In the unlikely event that challenges arise, we are dedicated to working together to find solutions and ensure your success. We will work with your team until we are able get you the desired results.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "A minimal and strategic investment of your time 0-3 Months Audit current systems, gather information on target clients, create an offer overview, and participate in generating new pipeline.",
    },
    {
      question: "What does this partnership entail?",
      answer:
        "We learn, work, and collaborate seamlessly with your team, sharing knowledge while maintaining accountability as partners committed to delivering results. We assist in building and expanding your business in exchange for a share in the success.",
    },
    {
      question: "How much of a time commitment is required?",
      answer:
        "We are fully committed to your success and will invest as much time as necessary to achieve the desired results. As dedicated partners, we complete all tasks without excuses, ensuring your objectives are met.",
    },
  ];
  ...
  return (
    <div
      ...
      className="bg-[#020a13] mt-[-320px] md:mt-[-150px] text-white min-h-screen flex flex-col items-center justify-center"
    >
